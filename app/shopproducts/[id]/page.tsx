        ...
        <div className="container mx-auto flex flex-col sm:flex-row items-center sm:items-start justify-center sm:justify-normal">
          ...
          <div className="ml-[0rem] md:ml-[1rem] lg:ml-[3.5rem] xl:ml-[5.5rem] 2xl:ml-[8.5rem] relative">
            <Image
              ...
              height={450}
              alt="Product-one"
              className="w-[18rem] sm:w-[35rem] md:w-[18rem] lg:w-[18rem]"
            />
            ...
            <Image
              ...
              height={42.47}
              alt="Product-one"
              className="absolute top-40 sm:top-48 w-[1.3rem] sm:w-[1.1rem] left-[2rem] sm:left-[1.8rem]"
            />
            ...
            <Image
              ...
              height={42.47}
              alt="Product-one"
              className="absolute top-40 sm:top-48 left-[15rem] sm:left-[15.3rem] w-[1.3rem] sm:w-[1.1rem]"
            />
          ...
          <div className="space-y-2 ml-[4rem] sm:ml-[2rem] md:ml-[2rem] lg:ml-[2.9rem] xl:ml-[2.4rem] 2xl:ml-[2.9rem] flex flex-col sm:flex-col items-start sm:items-start justify-center mx-[0rem] sm:mx-auto mt-8 sm:mt-2">
            {/* Product title */}
